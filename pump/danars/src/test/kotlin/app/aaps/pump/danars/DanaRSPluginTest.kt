...
class DanaRSPluginTest : DanaRSTestBase() {
    ...
    fun prepareMocks() {
        ...
        danaRSPlugin =
            DanaRSPlugin(
                aapsLogger, rh, preferences, config, commandQueue, aapsSchedulers, rxBus, context, constraintChecker, profileFunction, danaPump, pumpSync, detailedBolusInfoStorage, temporaryBasalStorage,
