...
class OpenHumansUploaderPluginTest : TestBaseWithProfile() {
    ...
    @BeforeEach fun prepare() {
        ...
        openHumansUploaderPlugin = OpenHumansUploaderPlugin(rh, aapsLogger, preferences, config, context, persistenceLayer, openHumansAPI, stateDelegate, counterDelegate, appIdDelegate, rxBus)
    }
