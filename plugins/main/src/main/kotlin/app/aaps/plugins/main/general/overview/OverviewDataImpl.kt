...
class OverviewDataImpl @Inject constructor(
    ...
    */
    ...
    override fun clearGraphViewRefs() {
        bucketedGraphSeries.clearGraphViews()
        bgReadingGraphSeries.clearGraphViews()
        predictionsGraphSeries.clearGraphViews()
        baseBasalGraphSeries.clearGraphViews()
        tempBasalGraphSeries.clearGraphViews()
        basalLineGraphSeries.clearGraphViews()
        absoluteBasalGraphSeries.clearGraphViews()
        temporaryTargetSeries.clearGraphViews()
        activitySeries.clearGraphViews()
        activityPredictionSeries.clearGraphViews()
        iobSeries.clearGraphViews()
        absIobSeries.clearGraphViews()
        iobPredictions1Series.clearGraphViews()
        minusBgiSeries.clearGraphViews()
        minusBgiHistSeries.clearGraphViews()
        cobSeries.clearGraphViews()
        cobMinFailOverSeries.clearGraphViews()
        deviationsSeries.clearGraphViews()
        ratioSeries.clearGraphViews()
        dsMaxSeries.clearGraphViews()
        dsMinSeries.clearGraphViews()
        treatmentsSeries.clearGraphViews()
        epsSeries.clearGraphViews()
        therapyEventSeries.clearGraphViews()
        heartRateGraphSeries.clearGraphViews()
        stepsCountGraphSeries.clearGraphViews()
        varSensSeries.clearGraphViews()
    }
}
