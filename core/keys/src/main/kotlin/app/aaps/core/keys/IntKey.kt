...
enum class IntKey(
    ...
    OverviewCageWarning(key = "statuslights_cage_warning", defaultValue = 48, min = 24, max = 240, titleResId = R.string.pref_title_cage_warning, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.HOURS),
    OverviewCageCritical(key = "statuslights_cage_critical", defaultValue = 72, min = 24, max = 240, titleResId = R.string.pref_title_cage_critical, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.HOURS),
    OverviewIageWarning(
        ...
        defaultedBySM = true,
        dependency = BooleanKey.OverviewShowStatusLights,
    ...
    OverviewSageWarning(key = "statuslights_sage_warning", defaultValue = 216, min = 24, max = 720, titleResId = R.string.pref_title_sage_warning, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.HOURS),
    OverviewSageCritical(key = "statuslights_sage_critical", defaultValue = 240, min = 24, max = 720, titleResId = R.string.pref_title_sage_critical, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.HOURS),
    OverviewSbatWarning(key = "statuslights_sbat_warning", defaultValue = 25, min = 0, max = 100, titleResId = R.string.pref_title_sbat_warning, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.PERCENT),
    OverviewSbatCritical(key = "statuslights_sbat_critical", defaultValue = 5, min = 0, max = 100, titleResId = R.string.pref_title_sbat_critical, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.PERCENT),
    OverviewBageWarning(key = "statuslights_bage_warning", defaultValue = 216, min = 24, max = 1000, titleResId = R.string.pref_title_bage_warning, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.HOURS),
    OverviewBageCritical(key = "statuslights_bage_critical", defaultValue = 240, min = 24, max = 1000, titleResId = R.string.pref_title_bage_critical, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.HOURS),
    OverviewResWarning(key = "statuslights_res_warning", defaultValue = 80, min = 0, max = 300, titleResId = R.string.pref_title_res_warning, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.INSULIN_INT),
    OverviewResCritical(key = "statuslights_res_critical", defaultValue = 10, min = 0, max = 300, titleResId = R.string.pref_title_res_critical, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.INSULIN_INT),
    OverviewBattWarning(key = "statuslights_bat_warning", defaultValue = 51, min = 0, max = 100, titleResId = R.string.pref_title_batt_warning, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.PERCENT),
    OverviewBattCritical(key = "statuslights_bat_critical", defaultValue = 26, min = 0, max = 100, titleResId = R.string.pref_title_batt_critical, defaultedBySM = true, dependency = BooleanKey.OverviewShowStatusLights, unitType = UnitType.PERCENT),
